...
class Painel1:
    ...
    def banner(self):
        ...
        print(f" {self.C_WHITE}[+] DRAGON FRAMEWORK v2.1{self.RESET} | {self.C_GRAY}Dev:{self.RESET} {self.C_GREEN}scxveryx{self.RESET}")
        print(f" {self.C_PINK}doxx {self.RESET}")
    ...
    def abrir_interface(self):
        ...
        while True:
            ...
            print(f"{self.C_WHITE}┌──({self.C_KALI}kali㉿davi-termux{self.C_WHITE})-[{self.C_GRAY}~/painel{self.C_WHITE}]{self.RESET}")
