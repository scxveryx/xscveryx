  ...
  ...... NNN.MNO! . O!!!!!!!!!O . OONO NO! ........
   ...
   ...... MNNNNO! .. PPPPPPPPP .. MMNON!........
      ...... OO! ................. ON! .......
        ...
        print(f" {self.C_WHITE}[+] {self.C_GRAY}Dev:{self.RESET} {self.C_GREEN} vbought {self.RESET}")
        print(f" {self.C_GRAY}[+] Dispositivo:{self.RESET} {self.C_YELLOW}{dispositivo}{self.RESET}")
        print(f" {self.C_GRAY}[+] Ip Target: Linux / Android System{self.RESET}")
        print(f"{self.C_GRAY}====================================================={self.RESET}\n")
